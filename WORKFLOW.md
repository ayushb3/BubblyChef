...
| Stage | Who | Way out |
|---|---|---|
| Preflight | Sonnet gathers facts; **the script decides** | Stops if `AGENTS_ENABLED` isn't `true`, 15 loop PRs were opened in the last 24 hours (raised from 3 to 6 on 2026-09-19, to 15 on 2026-09-23 for ship mode), the issue isn't open and `ready-for-agent`, or a PR is already on it |

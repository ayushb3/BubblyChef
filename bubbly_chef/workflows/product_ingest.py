...
PRODUCT_PARSE_SYSTEM_PROMPT = """You are a helpful assistant that parses product descriptions into structured item data.
        ...
        if error or result is None:
            ...
            return {
                **state,
                ...
                "confidence": 0.3,
                "errors": state.get("errors", []) + [f"Could not parse product description"],
            }

...
import { FoodNameTypeahead } from '../components/FoodNameTypeahead';
...
/**
 * Thin wrapper around the shared FoodNameTypeahead that holds per-item
 * controlled state so the Scan page's ref-based submit pattern still works.
 */
function ScanItemNameInput({
  defaultValue,
  borderColor,
  inputRef,
  onSelect,
